...
With only 3 studies, each fold has 2 training studies (k=2 minimum for meta-analysis).
...
MIN_STABLE_FRAC = 2/3   # matches plot_lodo_forest_combined.R: ceiling(3 * 2/3) = 2
MODEL_CONFIGS = {
    "RF": {
...
if __name__ == "__main__":
    ...
    pd.DataFrame(sup_rows).to_csv(
        os.path.join(TAB_DIR, "Supplementary_Table_lodo_fold_signatures_canine.csv"), index=False)
